...
QuadTreeNode *FreeQuadTreeNode(QuadTreeNode* node)
{
    if (node->northWest != NULL) node->northWest = FreeQuadTreeNode(node->northWest);
    if (node->northEast != NULL) node->northEast = FreeQuadTreeNode(node->northEast);
    if (node->southWest != NULL) node->southWest = FreeQuadTreeNode(node->southWest);
    if (node->southEast != NULL) node->southEast = FreeQuadTreeNode(node->southEast);
